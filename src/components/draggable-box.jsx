...
export class DraggableResizableBox extends React.Component {
    ...
    componentDidMount() {
        ...
        document.addEventListener('mouseup', this.eventEnd.bind(this))
        document.addEventListener('touchmove', this.eventMove.bind(this))
        document.addEventListener('touchend', this.eventEnd.bind(this))
    ...
    componentWillUnmount() {
        document.removeEventListener('mousemove', this.eventMove.bind(this))
        document.removeEventListener('mouseup', this.eventEnd.bind(this))
        document.removeEventListener('touchmove', this.eventMove.bind(this))
        document.removeEventListener('touchend', this.eventEnd.bind(this))
    ...
    render() {
        ...
        return (
            <div ref='box' className='DraggableResizable'>
                <div className='DraggableResizable-controls'>
                    <label>
                        ...
                        <input
                            ...
                            onChange={this.controlsMoveBox.bind(this)}
                            tabIndex="-1"
                            type='number' />
                    </label>
                    <label>
                    ...
                    <label>
                        ...
                        <input
                            ...
                            type='number'
                            tabIndex="-1"
                            onChange={this.controlsResize.bind(this)} />
                    </label>
                    <label>
                ...
                <div style={style} onMouseDown={this.startMove.bind(this)} onTouchStart={this.startMove.bind(this)}>
                    {this.props.children}
                    <div className='resize-handle resize-handle-se'
                        onMouseDown={this.startResize.bind(this, 'se')}
                        onTouchStart={this.startResize.bind(this, 'se')}>
                    </div>
                    <div className='resize-handle resize-handle-ne'
                        onMouseDown={this.startResize.bind(this, 'ne')}
                        onTouchStart={this.startResize.bind(this, 'ne')}>
                    </div>
                    <div className='resize-handle resize-handle-sw'
                        onMouseDown={this.startResize.bind(this, 'sw')}
                        onTouchStart={this.startResize.bind(this, 'sw')}>
                    </div>
                    <div className='resize-handle resize-handle-nw'
                        onMouseDown={this.startResize.bind(this, 'nw')}
                        onTouchStart={this.startResize.bind(this, 'nw')}>
                    </div>
                </div>
...
DraggableResizableBox.defaultProps = {
    widthLabel: 'Width',
    heightLabel: 'Height',
